...
export function ViewToggle() {
  ...
  return (
    <div className="dt-view-toggle" role="group" aria-label="Model view">
      <button
        type="button"
        className={`dt-view-option${cutaway ? "" : " active"}`}
      ...
      <span className={`dt-view-thumb${cutaway ? " right" : ""}`} aria-hidden="true" />
    </div>
  );
}
